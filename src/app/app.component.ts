...
@Component({
  selector: 'app-root',
  imports: [FieldSettingsComponent, FormElementsMenuComponent, MainCanvasComponent, DragDropModule],
  template: `
    <div class="flex flex-col h-screen bg-gray-100 px-4">
      <div class="flex flex-col gap-1 items-center justify-center py-10">
        ...
        <p class="text-gray-500">Create beautiful, responsive forms with Angular Material and Tailwind Css</p>
      </div>
